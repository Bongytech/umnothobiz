warning: in the working copy of 'umnotho/eslint.config.js', LF will be replaced by CRLF the next time Git touches it
[1mdiff --git a/umnotho/eslint.config.js b/umnotho/eslint.config.js[m
[1mindex 092408a..aa22d53 100644[m
[1m--- a/umnotho/eslint.config.js[m
[1m+++ b/umnotho/eslint.config.js[m
[36m@@ -1,28 +1,57 @@[m
...
[31m-import tseslint from 'typescript-eslint'[m
[32m+[m[32mimport tseslint from 'typescript-eslint';[m
[32m+[m[32mimport securityPlugin from 'eslint-plugin-security';[m
[32m+[m[32mimport securityNodePlugin from 'eslint-plugin-security-node';[m
 [m
 export default tseslint.config([m
[31m-  { ignores: ['dist'] },[m
[32m+[m[32m  // IGNORE PATTERNS[m
[32m+[m[32m  {[m
[32m+[m[32m    ignores: [[m
[32m+[m[32m      'dist/**',[m
...
[32m+[m[32m      'security-check.js'[m
[32m+[m[32m    ][m
[32m+[m[32m  },[m
[32m+[m[41m  [m
[32m+[m[32m  // TYPESCRIPT CONFIG[m
[32m+[m[32m  ...tseslint.configs.recommended,[m
[32m+[m[41m  [m
[32m+[m[32m  // SECURITY CONFIG[m
   {[m
[31m-    extends: [js.configs.recommended, ...tseslint.configs.recommended],[m
[31m-    files: ['**/*.{ts,tsx}'],[m
...
[31m-    },[m
     plugins: {[m
[31m-      'react-hooks': reactHooks,[m
[31m-      'react-refresh': reactRefresh,[m
[32m+[m[32m      security: securityPlugin,[m
[32m+[m[32m      'security-node': securityNodePlugin[m
     },[m
     rules: {[m
[31m-      ...reactHooks.configs.recommended.rules,[m
...
[31m-  },[m
[31m-)[m
[32m+[m[32m      // Disable noisy rules[m
[32m+[m[32m      'security/detect-object-injection': 'off',[m
[32m+[m[32m      'security/detect-non-literal-require': 'off',[m
[32m+[m[32m      'security/detect-non-literal-fs-filename': 'off',[m
[32m+[m[32m      'security-node/detect-crlf': 'off',[m
[32m+[m[41m      [m
[32m+[m[32m      // Keep important rules[m
[32m+[m[32m      'security/detect-buffer-noassert': 'error',[m
[32m+[m[32m      'security/detect-child-process': 'error',[m
[32m+[m[32m      'security/detect-disable-mustache-escape': 'error',[m
[32m+[m[32m      'security/detect-eval-with-expression': 'error',[m
[32m+[m[32m      'security/detect-no-csrf-before-method-override': 'error',[m
[32m+[m[32m      'security/detect-non-literal-regexp': 'error',[m
[32m+[m[32m      'security/detect-possible-timing-attacks': 'error',[m
[32m+[m[32m      'security/detect-pseudoRandomBytes': 'error',[m
[32m+[m[32m      'security/detect-unsafe-regex': 'error',[m
[32m+[m[32m      'security-node/detect-dangerous-redirects': 'error',[m
[32m+[m[32m      'security-node/detect-insecure-randomness': 'error',[m
[32m+[m[32m      'security-node/detect-buffer-unsafe-allocation': 'error',[m
[32m+[m[41m      [m
[32m+[m[32m      // TypeScript rules[m
[32m+[m[32m      '@typescript-eslint/no-explicit-any': 'warn',[m
[32m+[m[32m      '@typescript-eslint/no-unused-vars': ['warn', {[m
[32m+[m[32m        'argsIgnorePattern': '^_',[m
[32m+[m[32m        'varsIgnorePattern': '^_'[m
[32m+[m[32m      }][m
[32m+[m[32m    }[m
[32m+[m[32m  }[m
[32m+[m[32m);[m
